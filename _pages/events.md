...
- [BIOPIM Workshop]({{ site.baseurl }}/events/workshop): October 6-7, 2026; Ankara, Turkey

  A two-day workshop on leveraging Processing in Memory (PIM) techniques to accelerate genomic applications.

  For details on the program and speakers, visit: [BIOPIM Workshop]({{ site.baseurl }}/events/workshop)
